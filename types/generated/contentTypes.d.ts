...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    payment_method: Schema.Attribute.Enumeration<['card', 'transfer', 'cash']> &
    ...
    publishedAt: Schema.Attribute.DateTime;
    shipping_address: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    min_stock_level: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    original_price: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
